...
function Footer() {
  return (
    <footer>
      ...
      <p>Special thanks to <a href="https://github.com/yujisatojr/react-portfolio-template" target="_blank" rel="noreferrer">Yuji Sato</a> for letting me use his portfolio template</p>
    </footer>
  );
}
